...
<p align="center">
  Project Page / Research Repository
</p>
...
### Key idea
- **Inside the assigned temporal window:** attention is preserved.
- **Outside the window:** attention is smoothly attenuated based on temporal distance.
- **Near boundaries:** a boundary-aware decay suppresses cross-segment interference.
